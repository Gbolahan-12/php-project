...
$user_id = $_SESSION['user_id']; // Make sure you set this after login!
        ...
        <div class="col-xl-4">
          ...
          <div class="card">
            <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
              ...
              <img src="uploads/<?= htmlspecialchars($profile['profile_pic'] ?? 'default.png') ?>" alt="Profile" class="rounded-circle">
              <h2>
              ...
              <div class="tab-content pt-2">
                ...
                <div class="tab-pane fade show active profile-overview" id="profile-overview">
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8"> <img src="uploads/<?=  htmlspecialchars($profile['profile_pic'] ?? 'default.png') ?>" width="100">   </div>
                  </div>
                  ...
                  <form action="profile_process.php" method="POST" enctype="multipart/form-data">
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <img src="uploads/<?=  htmlspecialchars($profile['profile_pic'] ?? 'default.png') ?>" alt="Profile">
                        <i class="pt-2">
                ...
                <div class="tab-pane fade pt-3" id="profile-change-password">
                  ...
                  <form action="../Admin/admin-dashboard/change-pwd.php" method="POST">
